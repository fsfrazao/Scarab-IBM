...
"""
This file is part of Scarab-IBM.

    Scarab-IBM is free software: you can redistribute it and/or modify
    ...
    along with Scarab_IBM.  If not, see <http://www.gnu.org/licenses/>.


    Scarab_IBM is writthen by Fabio Soares Frazao <fsfrazao@gmail.com>
    The software in this file modifie John Zelle's library "graphics.py"
    
    Fabio Soares Frazao, hereby disclaims all copyright interest in the code 
...
# Scarab-IBM version
#   Added  move_to to Circle, to allow the object to move to a a given
#   x,y coordinate, instead of moving x,y units.
#
#
# Version 2.0.1
